...
- /Bad/: drops to Box 1 (forgot important details, note felt unfamiliar).

*There are a couple new options designed for the nuances around reading:*
- /Partial/ (new): For files too long to finish reading in one sitting. The file is *paused* and comes due again the next day so you can pick up where you left off. The =dashboard= shows a =Paused= indicator until you give it a real rating. Works well with =save-place-mode=.
